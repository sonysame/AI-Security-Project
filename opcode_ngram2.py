...
def main():
	...
	total_3gram_opcode = []
	with open("3gram.csv", 'r') as reader:
		data = reader.read()
		lines = data.split("\n")[1:-1]
	for i in lines:
		tmp = i.split(')')[0].replace('(', '').replace('"', '').replace(' ', '')
	...
	total_4gram_opcode = []
	with open("4gram.csv", 'r') as reader:
		data = reader.read()
		lines = data.split("\n")[1:-1]
	for i in lines:
		tmp = i.split(')')[0].replace('(', '').replace('"', '').replace(' ', '')
	...
	_2_binary_antipatch_calc_idf = np.round(124 / np.log2(_2antipatch_df + _2original_df + 0.1), 4)
	_2_binary_antipatch_tf_idf=np.round(np.multiply(_2antipatch_calc_tf, _2_binary_antipatch_calc_idf),4)
	_2_multiple_antipatch_calc_idf = np.round(
		248 / np.log2(_2antipatch_df + _2antidump_df+_2antivm_df+_2original_df + 0.1), 4)
	_2_multiple_antipatch_tf_idf = np.round(np.multiply(_2antipatch_calc_tf, _2_multiple_antipatch_calc_idf),4)

	_2antidump_calc_tf = np.round(_2antidump_tf / np.sum(_2antidump_tf), 4)
	_2_binary_antidump_calc_idf = np.round(124 / np.log2(_2antidump_df + _2original_df + 0.1), 4)
	_2_binary_antidump_tf_idf = np.round(np.multiply(_2antidump_calc_tf, _2_binary_antidump_calc_idf),4)
	_2_multiple_antidump_calc_idf = np.round(
		248 / np.log2(_2antidump_df + _2antidump_df + _2antivm_df + _2original_df + 0.1), 4)
	_2_multiple_antidump_tf_idf = np.round(np.multiply(_2antidump_calc_tf, _2_multiple_antidump_calc_idf),4)

	_2antivm_calc_tf = np.round(_2antivm_tf / np.sum(_2antivm_tf), 4)
	_2_binary_antivm_calc_idf = np.round(124 / np.log2(_2antivm_df + _2original_df + 0.1), 4)
	_2_binary_antivm_tf_idf = np.round(np.multiply(_2antivm_calc_tf, _2_binary_antivm_calc_idf),4)
	_2_multiple_antivm_calc_idf = np.round(
		248 / np.log2(_2antivm_df + _2antivm_df + _2antivm_df + _2original_df + 0.1), 4)
	_2_multiple_antivm_tf_idf = np.round(np.multiply(_2antivm_calc_tf, _2_multiple_antivm_calc_idf),4)

	_3antipatch_calc_tf = np.round(_3antipatch_tf / np.sum(_3antipatch_tf), 4)
	_3_binary_antipatch_calc_idf = np.round(124 / np.log2(_3antipatch_df + _3original_df + 0.1), 4)
	_3_binary_antipatch_tf_idf = np.round(np.multiply(_3antipatch_calc_tf, _3_binary_antipatch_calc_idf),4)
	_3_multiple_antipatch_calc_idf = np.round(
		248 / np.log2(_3antipatch_df + _3antidump_df + _3antivm_df + _3original_df + 0.1), 4)
	_3_multiple_antipatch_tf_idf = np.round(np.multiply(_3antipatch_calc_tf, _3_multiple_antipatch_calc_idf),4)

	_3antidump_calc_tf = np.round(_3antidump_tf / np.sum(_3antidump_tf), 4)
	_3_binary_antidump_calc_idf = np.round(124 / np.log2(_3antidump_df + _3original_df + 0.1), 4)
	_3_binary_antidump_tf_idf = np.round(np.multiply(_3antidump_calc_tf, _3_binary_antidump_calc_idf),4)
	_3_multiple_antidump_calc_idf = np.round(
		248 / np.log2(_3antidump_df + _3antidump_df + _3antivm_df + _3original_df + 0.1), 4)
	_3_multiple_antidump_tf_idf = np.round(np.multiply(_3antidump_calc_tf, _3_multiple_antidump_calc_idf),4)

	_3antivm_calc_tf = np.round(_3antivm_tf / np.sum(_3antivm_tf), 4)
	_3_binary_antivm_calc_idf = np.round(124 / np.log2(_3antivm_df + _3original_df + 0.1), 4)
	_3_binary_antivm_tf_idf = np.round(np.multiply(_3antivm_calc_tf, _3_binary_antivm_calc_idf),4)
	_3_multiple_antivm_calc_idf = np.round(
		248 / np.log2(_3antivm_df + _3antivm_df + _3antivm_df + _3original_df + 0.1), 4)
	_3_multiple_antivm_tf_idf = np.round(np.multiply(_3antivm_calc_tf, _3_multiple_antivm_calc_idf),4)

	_4antipatch_calc_tf = np.round(_4antipatch_tf / np.sum(_4antipatch_tf), 4)
	_4_binary_antipatch_calc_idf = np.round(124 / np.log2(_4antipatch_df + _4original_df + 0.1), 4)
	_4_binary_antipatch_tf_idf = np.round(np.multiply(_4antipatch_calc_tf, _4_binary_antipatch_calc_idf),4)
	_4_multiple_antipatch_calc_idf = np.round(
		248 / np.log2(_4antipatch_df + _4antidump_df + _4antivm_df + _4original_df + 0.1), 4)
	_4_multiple_antipatch_tf_idf = np.round(np.multiply(_4antipatch_calc_tf, _4_multiple_antipatch_calc_idf),4)

	_4antidump_calc_tf = np.round(_4antidump_tf / np.sum(_4antidump_tf), 4)
	_4_binary_antidump_calc_idf = np.round(124 / np.log2(_4antidump_df + _4original_df + 0.1), 4)
	_4_binary_antidump_tf_idf = np.round(np.multiply(_4antidump_calc_tf, _4_binary_antidump_calc_idf),4)
	_4_multiple_antidump_calc_idf = np.round(
		248 / np.log2(_4antidump_df + _4antidump_df + _4antivm_df + _4original_df + 0.1), 4)
	_4_multiple_antidump_tf_idf = np.round(np.multiply(_4antidump_calc_tf, _4_multiple_antidump_calc_idf),4)

	_4antivm_calc_tf = np.round(_4antivm_tf / np.sum(_4antivm_tf), 4)
	_4_binary_antivm_calc_idf = np.round(124 / np.log2(_4antivm_df + _4original_df + 0.1), 4)
	_4_binary_antivm_tf_idf = np.round(np.multiply(_4antivm_calc_tf, _4_binary_antivm_calc_idf),4)
	_4_multiple_antivm_calc_idf = np.round(
		248 / np.log2(_4antivm_df + _4antivm_df + _4antivm_df + _4original_df + 0.1), 4)
	_4_multiple_antivm_tf_idf = np.round(np.multiply(_4antivm_calc_tf, _4_multiple_antivm_calc_idf),4)
