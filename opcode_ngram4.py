...
_2gram_antipatch_multiple_sorted=_2gram_antipatch_df.sort_values(by=['2gram_binary_antipatch_TF-IDF'], ascending=False)
...
_2gram_antidump_multiple_sorted=_2gram_antidump_df.sort_values(by=['2gram_binary_antidump_TF-IDF'], ascending=False)
...
_2gram_antivm_multiple_sorted=_2gram_antivm_df.sort_values(by=['2gram_binary_antivm_TF-IDF'], ascending=False)
...
_3gram_antipatch_multiple_sorted=_3gram_antipatch_df.sort_values(by=['3gram_binary_antipatch_TF-IDF'], ascending=False)
...
_3gram_antidump_multiple_sorted=_3gram_antidump_df.sort_values(by=['3gram_binary_antidump_TF-IDF'], ascending=False)
...
_3gram_antivm_multiple_sorted=_3gram_antivm_df.sort_values(by=['3gram_binary_antivm_TF-IDF'], ascending=False)
...
_4gram_antipatch_multiple_sorted=_4gram_antipatch_df.sort_values(by=['4gram_binary_antipatch_TF-IDF'], ascending=False)
...
_4gram_antidump_multiple_sorted=_4gram_antidump_df.sort_values(by=['4gram_binary_antidump_TF-IDF'], ascending=False)
...
_4gram_antivm_multiple_sorted=_4gram_antivm_df.sort_values(by=['4gram_binary_antivm_TF-IDF'], ascending=False)
